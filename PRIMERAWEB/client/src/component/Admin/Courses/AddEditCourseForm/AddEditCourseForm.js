...
function AddEditForm(props) {
  ...
  return (
    ...
    >
      <Form.Item>
        <Input
          prefix={<KeyOutlined className="icon-add-edit-form" />}
      ...
      <Form.Item>
        <Input
          prefix={<LinkedinOutlined className="icon-add-edit-form" />}
      ...
      <Form.Item>
        <Input
          prefix={<GifOutlined className="icon-add-edit-form" />}
      ...
      <Form.Item>
        <Input
          prefix={<DollarOutlined className="icon-add-edit-form" />}
